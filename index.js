...
if (message.content === prefix + "onmain") {
 ...
 let args1 = cont.slice(1)
   ...
   if (message.content === prefix + "help admin") {
    ...
    if (message.content === prefix + "help") {
     let help2= new Discord.RichEmbed ()
         ...
         .addField ("**__Membres__** :busts_in_silhouette: :", "`setup`, `help`, `ping`,`avatar`,`afk`, `remafk`, `invite`, `check`,`google`, `youtube`, `playstore`,`h`", false)
   ...
   if (message.content === prefix +`serverinfo`){
     	...
     	.addField("Date de création", `{moment.utc(definedUser.createdAt).format("D/M/Y, HH:mm:ss")} (${ms(Date.now()- moment.utc(definedUser.createdAt), {long: true})})`, false )
     	.addField("Date de venue", `{moment.utc(definedUser.createdAt).format("D/M/Y, HH:mm:ss")} (${ms(Date.now()- moment.utc(definedUser.createdAt), {long: true})})`, false )
